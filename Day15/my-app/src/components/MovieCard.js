...
import { addToFavorite,removeFromFavourite } from "../redux/MovieActions";

function MovieCard({movie}){
    const dispatch=useDispatch();
    const {favorite}=useSelector(state=>state.movie)

    const findMovie=favorite.find(fav=>fav.id==movie.id)
            ...
            <div className="info">
                <div className="content">
                    ...
                    <div className="action">
                        ...
                        {!findMovie && <button onClick={() => dispatch(addToFavorite(movie))}>Add To Favourite</button>
                        }
